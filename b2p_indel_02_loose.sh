...
Usage: $(basename "$0") -R referance_genome.fasta [OPTION]... Input_VCF.vcf
  ...
  -t [primer3 template file]    default:"template/template_ind.txt"
EOM
  exit 2
}
...
MIN_DEP=10
MAX_DEP=60
TEMP="template/template_ind.txt"
...
perl perl/select_indel_loose.pl ${VCF}\
...
perl perl/make_format_indel_loose.pl ${CURRENT}/${NAME}_selected.vcf \
                               ${CURRENT}/${NAME}_sequences.fasta \
                               ${TEMP} ${CURRENT}/${NAME}_primer3 \
                               300 0
